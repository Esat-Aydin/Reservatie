...
namespace Chair
{
    public class StoelKeuze
    {
        ...
        public void Chair()
        {
            ...
            string myRoomData = new WebClient().DownloadString(@"C:\Users\woute\source\repos\Esat-Aydin\Reservatie\Reservatie\Esat-Aydin\Reservatie\Reservatie\seats (2).json");
