...
namespace Chair
{
    public class StoelKeuze
    {
        ...
        public void Chair()
        {
            var MyFilmsData = new WebClient().DownloadString(@"C:\Users\Edward\Source\Repos\Reservatie\Reservatie\Filmsdata.json");
            string myJsonString = new WebClient().DownloadString(@"C:\Users\Edward\Source\Repos\Reservatie\Reservatie\snacksdrinks.json");
            string myUserData = new WebClient().DownloadString(@"C:\Users\Edward\Source\Repos\Reservatie\Reservatie\SampleLog.json");
            string myRoomData = new WebClient().DownloadString(@"C:\Users\Edward\Source\Repos\Reservatie\Reservatie\seats (2).json");
